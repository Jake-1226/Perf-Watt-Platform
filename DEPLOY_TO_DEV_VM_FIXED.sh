#!/bin/bash
# Complete Deployment Script for Dev VM (Windows Compatible)
...
LOCAL_DIR="/mnt/c/Users/ManuNicholas_Jacob/CascadeProjects/windsurf-project/perf-platform"
...
copy_files_to_vm() {
    ...
    # Copy all files using SCP with Windows path handling
